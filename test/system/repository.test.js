    ...
    describe('package.json', function () {
        ...
        describe('package.json JSON data', function () {
            it('should have valid name, description and author', function () {
                expect(json).to.have.property('name', 'newman-reporter-confluence');
                expect(json).to.have.property('description', 'A Newman Reporter to upload report on Confluence');
                expect(json).to.have.property('author', 'Stefano Stoduto <stefano.stoduto@gmail.com> (=)');
                expect(json).to.have.property('license', 'Apache-2.0');
                expect(json).to.have.property('homepage', 'https://github.com/OmbraDiFenice/newman-reporter-confluence');
                expect(json).to.have.property('bugs', 'https://github.com/OmbraDiFenice/newman-reporter-confluence/issues');
                ...
                expect(json.keywords).to.eql(['newman', 'reporter', 'confluence']);
